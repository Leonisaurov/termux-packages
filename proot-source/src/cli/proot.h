...
\t! character: -b *host_path*:*guest_location!*.",
	...
	{ .class = "Regular options",
	  .arguments = {
		{ .name = "-m", .separator = ' ', .value = "host:guest" },
...
\twill lead to 2 different IPC Namespaces",
	...
	{ .class = "Extension options",
	  .arguments = {
        ...
        { .class = "Extension options",
          .arguments = {
                { .name = "-p", .separator = ' ', .value = "host:container" },
                { .name = "--port", .separator = '=', .value = "host:container" },
                { .name = NULL, .separator = '\0', .value = NULL } },
          .handler = handle_option_port_mapping,
          .description = "Map host port to container port (e.g., -p 8080:80).",
          .detail = "\tExplicitly map a host port to a container port.\n\
\tMultiple -p flags can be specified.\n\
\tIf the host port is occupied, proot will search for the next free port.",
        },
        { .class = "Extension options",
          .arguments = {
                { .name = "--protect-privileged-ports", .separator = '\0', .value = NULL },
                { .name = NULL, .separator = '\0', .value = NULL } },
          .handler = handle_option_p,
          .description = "Auto-redirect privileged ports (<1024) by +2000, finding free ports.",
